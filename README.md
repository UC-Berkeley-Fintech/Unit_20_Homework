...
![Associate_wallets](Images/Associate_wallets.png)

#### Execute the contract
![Associate_contract](Images/AssociateProfitSplitter.png)
![Associate_contract](Images/contract_call.png)

#### Wallet balances
![Associate_wallets](Images/Associate_dist.png)
...
#### Wallet addresses used
![Tiered_wallets](Images/Tiered_wallets.png)

#### Execute the contract
![Tiered_contract](Images/TieredProfitSplitter.png)
![Tiered_contract](Images/dist_contract_call.png)

#### Wallet balances
![Tiered_wallets](Images/Tiered_dist.png)
...
![Deferred_contract](Images/deferred.png)

![Deferred_contract](Images/deferred_contract.png)
